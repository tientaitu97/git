<%-- 
    Document   : store
    Created on : Feb 19, 2020, 9:54:48 AM
    Author     : admin
--%>
		...
		<div class="content">
				...
				<div class="content-bottom store">
					...
					<div class="bottom-grid">
						...
						<div class="col-md-3 store-top">
							<div class="bottom-grid-top">
								<a href="single.jsp"><img class="img-responsive" src="images/sh1.png" alt="" >
								<div class="five">
								<h6 >-50%</h6>
								</div>
								<div class="pre">
						...
						<div class="col-md-3 store-top">
							<div class="bottom-grid-top">
								<a href="single.jsp"><img class="img-responsive" src="images/sh2.png" alt="" >
								<div class="five">
								<h6 class="one1">-50%</h6>
								</div>
								<div class="pre">
						...
						<div class="col-md-3 store-top">
							<div class="bottom-grid-top">
								<a href="single.jsp"><img class="img-responsive" src="images/sh3.png" alt="" >
								<div class="five">
								<h6 >-50%</h6>
								</div>
								<div class="pre">
					...
					<div class="bottom-grid">
						...
						<div class="col-md-3 store-top">
							<div class="bottom-grid-top">
								<a href="single.jsp"><img class="img-responsive" src="images/sh5.png" alt="" >
								<div class="five">
								<h6 class="one">-50%</h6>
								</div>
								<div class="pre">
					...
					<div class="bottom-grid">
						...
						<div class="col-md-3 store-top">
							<div class="bottom-grid-top">
								<a href="singlejsp"><img class="img-responsive" src="images/sh4.png" alt="" >
								<div class="five">
								<h6 class="one1">-50%</h6>
								</div>
								<div class="pre">
