<%-- 
    Document   : gifts
    Created on : Feb 19, 2020, 9:50:31 AM
    Author     : admin
--%>
		...
		<div class="content">
			<div class="col-md-9">
				<div class="col-md1">
					<div class="col-md-6">
					<div class="ut-in">
						<a href="single.jsp"><img class="img-responsive" src="images/gi5.jpg" alt=""></a>
							
							<div class="ut">
								<h6><a href="single.jsp">Ut tempor elit vel adipiscing</a></h6>
								<span>$1000.00</span>
								<a href="single.jsp" class="add">ADD TO CART</a>
						</div>
						</div>
					</div>
					<div class="col-md-6">
					<div class="ut-in">
						<a href="single.jsp"><img class="img-responsive" src="images/gi1.jpg" alt=""></a>
							<div class="ut">
								<h6><a href="single.jsp">Ut tempor elit vel adipiscing</a></h6>
								<span>$1000.00</span>
								<a href="single.jsp" class="add">ADD TO CART</a>
				...
				<div class="col-md1">
					<div class="col-md-6">
					<div class="ut-in">
						<a href="single.jsp"><img class="img-responsive" src="images/gi3.jpg" alt=""></a>
							<div class="ut">
								<h6><a href="single.jsp">Ut tempor elit vel adipiscing</a></h6>
								<span>$1000.00</span>
								<a href="single.jsp" class="add">ADD TO CART</a>
					...
					<div class="col-md-6">
					<div class="ut-in">
						<a href="single.jsp"><img class="img-responsive" src="images/gi2.jpg" alt=""></a>
							<div class="ut">
								<h6><a href="single.jsp">Ut tempor elit vel adipiscing</a></h6>
								<span>$1000.00</span>
								<a href="single.jsp" class="add">ADD TO CART</a>
				...
				<div class="col-md1">
					...
					<div class="col-md-6">
					<div class="ut-in">
						<a href="single.jsp"><img class="img-responsive" src="images/gi4.jpg" alt=""></a>
							<div class="ut">
								<h6><a href="single.jsp">Ut tempor elit vel adipiscing</a></h6>
								<span>$1000.00</span>
								<a href="single.jsp" class="add">ADD TO CART</a>
